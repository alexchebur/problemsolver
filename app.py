...
def apply_cognitive_method(method_name, context):
    ...
    - Для процессов и потоков пишите код визуализаций в формате Mermaid, СТРОГО код, начинающийся с пометки вида [```mermaid], СТРОГО вертикальной ориентации direction TD - top-down
    """
