...
def formulate_problem_and_queries():
    ...
    3. Создайте на основе рассуждений список из 5 поисковых запросов (на английском языке), расширяющих контекст и углубляющих исследование, для сбора информации
