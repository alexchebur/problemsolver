...
2. **Детальный план глав** (9 глав, объем каждой не менее 8000 слов):
   ...
   - Название главы (яркое, емкое, содержательное)
   - Действующие лица
...
3. **Персонажи** (НЕ менее 10, для каждого):
   - Имя и краткое описание
   - Характер, мотивация
   - Внутренний конфликт
   - Роль и движущая сила в сюжете
   - Как заканчивается путь персонажа в сюжете (если применимо)
...
- НЕ ЗЛОУПОТРЕБЛЯЙ КОЛИЧЕСТВОМ ДИАЛОГОВ, БОЛЬШЕ ДЕЙСТВИЙ И ПОСТУПКОВ ПЕРСОНАЖЕЙ
- НЕ ЗЛОУПОТРЕБЛЯЙ ШТАМПАМИ И КЛИШЕ
