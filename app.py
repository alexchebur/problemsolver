...
STRUCTURE_PROMPT = """
Ты - профессиональный писатель на уровне Толстого, Набокова, Пелевина, Сорокина. На основе предоставленных пользователем данных создай подробную структуру повести.
