...
2. **Детальный план глав** (минимум 8 глав, объем каждой главы не менее 8000 слов):
...
3. **Персонажи** (для каждого):
   ...
   - Чем заканчивается его путь в повести
...
- Естественные живые диалоги и описания
...
- Неожиданные развязка и финал в последних главах
...
def main():
    ...
    st.sidebar.info("""
    **Графоманъ** создает литературные произведения 
