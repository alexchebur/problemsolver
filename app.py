...
def formulate_problem_and_queries():
    ...
    3. Создайте на основе рассуждений список из 5 поисковых запросов (3 на русском языке, 2 на английском языке), расширяющих контекст и углубляющих исследование, для сбора информации
