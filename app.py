...
REASONING_STEPS = [
    "Проанализируй и структурируй запрос пользователя и контекст, сформулируй проблему, предложи пять тезисов из смежных запросу пользователя контекстов",
    "Сформулируй наиболее вероятные причины и предпосылки проблемы, сформулируй варианты решения проблемы с применением методов познания из {st.session_state.sys_prompt}",
    "Выбери оптимальные решения на основе {context}, сделай итоговые выводы о применении оптимальных решений"
]
