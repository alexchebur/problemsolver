...
EDITOR_PROMPT = """
Ты редактируешь художественный текст. Проанализируй представленную часть и перепиши ее, обогатив деталями описания событий, чувств и мыслей персонажей, исправив следующие ошибки:
