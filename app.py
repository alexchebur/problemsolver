...
def formulate_problem_and_queries():
    ...
    [Вывод на основе рассуждений 1]

    [Вопрос 2] - ДОЛЖЕН быть связан с предыдущим [Вывод на основе рассуждений 1]
    [Ответ 2]
    ...
    ЗАПРОСЫ:
    1. [Запрос 1]
...
def apply_cognitive_method(method_name, context):
    ...
    Специальные символы кроме букв, цифр и пробелов
