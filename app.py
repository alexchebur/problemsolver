...
def formulate_problem_and_queries():
    ...
    2. Проведите рассуждения (внутренний диалог из 10 шагов вопрос-ответы СТРОГО в формате каждого шага:[вопрос на уточнение проблемы, ответ на вопрос, сомнения в правильности ответа, возражение на сомнения]...)
    3. Создайте на основе рассуждений, исходного запроса {query} и контекста {doc_text} список СТРОГО из 5 поисковых запросов, цель которых - ответить на заданные в рамках внутреннего диалога вопросы и исследовать контекст в ширину
