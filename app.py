...
STRUCTURE_PROMPT = """
Ты - профессиональный писатель, мастер короткого рассказа. На основе предоставленных пользователем данных создай подробную структуру рассказа.

## Задача:
Создать структуру рассказа в жанре {genre} с сеттингом: {setting}
{alias_text}
{style_instruction}
...
- ИЗБЕГАЙ ЦЕПОЧЕК ОДНОСЛОЖНЫХ ПОВТОРЯЮЩИХСЯ ФРАЗ ВРОДЕ 'ОНА СДЕЛАЛА ЭТО', 'ОНА БЫЛА ГОТОВА'
...
EDITOR_PROMPT = """
Ты профессионально редактируешь художественный текст как полноценный соавтор. Проанализируй представленную часть и перепиши ее, обогатив деталями описания событий, чувств и мыслей персонажей, исправив следующие ошибки:
...
## ЗАДАЧА:
Перепиши без жалости часть, сохраняя сюжет и ключевые события, но улучшая литературное качество:
...
- Убери цепочки коротких односложных фраз вроде ["она смогла", "она поняла", "они сделали это"]
- Используй заданные структурой сюжета локации и предметы
